...
- **Anti-IPTV soglia**: `MAX_USERNAME=3` (riportato a 3 il 2026-06-28, era 2 dal 2026-06-20) su tutti i 53 VPS proxy. Due varianti script: bash (`/usr/local/sbin/anti-iptv.sh`) e python (`/usr/local/sbin/anti-iptv.py`). DynamoXc: NON installato, skippa sempre. Fix 2026-06-28: dropin `whitelist-netbird.conf` corretto su 5 VPS (bug `||` mancante causava crash loop anti-iptv); dropin aggiunto su 4 VPS che ne erano privi.
